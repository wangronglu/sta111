...
|------|---|---------------------|---|---------|---|----------|---|--------------|
| 07/03 | | Introduction & exploratory data analysis [Lec1.pdf](Lectures/lec1H.pdf) <br> Lab: [Intro to R & Rstudio](http://htmlpreview.github.io/?https://github.com/andrewpbray/oiLabs-base-R/blob/master/intro_to_r/intro_to_r.html), [Intro to Data](http://htmlpreview.github.io/?https://github.com/andrewpbray/oiLabs-base-R/blob/master/intro_to_data/intro_to_data.html) | | Ch 1.2, 1.6 | | [lab1](Labs/lab1.pdf) <br> [cdc.RData](Labs/cdc.RData) <br> [lab_report_template](Labs/rmarddown_lab_report_template.Rmd) <br> [rmarkdown-cheetsheet](Labs/rmarkdown-cheetsheet.pdf) | | 07/07 5pm |
